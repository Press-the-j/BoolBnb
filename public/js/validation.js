...
$(".title-input").on("change", function () {}); //? con questa funzione controlliamo che nell'input possa essere scritto solo quello che viene permesso dalla regex;

var inputArr = [".title-input", ".description-input", ".address-input"];
...
var inputNumberArr = [".postal_code-input", ".square_meters-input", ".max_guest-input", ".rooms-input", ".baths-input"];
